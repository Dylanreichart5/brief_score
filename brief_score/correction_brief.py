...
accuracy = accuracy_score(testLabelsStd, predict)
print(f"accuracy is {accuracy}")

# # # Matrix confusion
# plot_confusion_matrix(model, testFeatures_scaled, testLabelsStd) 
# plt.show()
train_score = model.score(learningFeatures_scaled, learningLabelsStd)
val_score = model.score(testFeatures_scaled, testLabelsStd)

# Print the scores
print("Training set score:", train_score)
print("Validation set score:", val_score)

# Check if the model is overfitting by comparing the train and validation scores
if train_score > val_score:
    print("Model is overfitting the training data.")
else:
    print("Model is not overfitting the training data.")